...
public:
	...
	class FCTradeItem
	{
		...
		public:
			...
			inline const Sint32 TypeHash_Market(void) const { return CHash::CRC32("Market"); }				//	マーケット
			inline const Sint32 TypeHash_Type(void) const { return CHash::CRC32("Type"); }					//	取引種別
			inline const Sint32 TypeHash_Currency(void) const { return CHash::CRC32("Currency"); }			//	通貨
			inline const Sint32 TypeHash_Price(void) const { return CHash::CRC32("Price"); }				//	価格
			inline const Sint32 TypeHash_PaymentPrice(void) const { return CHash::CRC32("PaymentPrice"); }	//	決済額
			inline const Sint32 TypeHash_BuyPrice(void) const { return CHash::CRC32("CostPrice"); }			//	購入時価格
			inline const Sint32 TypeHash_Amount(void) const { return CHash::CRC32("Amount"); }				//	数量
			inline const Sint32 TypeHash_TransAmount(void) const { return CHash::CRC32("TransAmount"); }	//	入出金数
			inline const Sint32 TypeHash_Date(void) const { return CHash::CRC32("Date"); }					//	取引日
			inline const Sint32 TypeHash_Time(void) const { return CHash::CRC32("Time"); }					//	取引時
			inline const Sint32 TypeHash_BuyDate(void) const { return CHash::CRC32("BuyDate"); }			//	購入日
			inline const Sint32 TypeHash_BuyTime(void) const { return CHash::CRC32("BuyTime"); }			//	購入時
			inline const Sint32 TypeHash_Margin(void) const { return CHash::CRC32("Margin"); }				//	取引差益
			inline const Sint32 TypeHash_Fee(void) const { return CHash::CRC32("Fee"); }					//	手数料
